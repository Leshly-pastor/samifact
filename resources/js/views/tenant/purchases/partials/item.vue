                ...
                <el-tab-pane class name="first">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <el-checkbox v-model="form.update_purchase_price"
                                >Actualizar precio de compra</el-checkbox
                            >
                            <el-checkbox v-model="form.update_price"
                                >Editar precio de venta</el-checkbox
                            >
                            <el-checkbox
                                v-show="!isLotEnabled"
       ...
       async open() {
        ...
        initForm() {
            ...
            this.form = {
                ...
                update_purchase_price: this.config
