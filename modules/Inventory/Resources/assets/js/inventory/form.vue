                ...
                <div class="row">
                    ...
                    <div class="col-md-4" v-if="type == 'input' && form.lots_enabled">
                        <div class="form-group" :class="{'has-danger': errors.lot_code}">
                            ...
                            <small class="text-danger" v-if="errors.lot_code"
                    ...
                    <div class="col-md-8">
                        <div class="form-group" :class="{'has-danger': errors.inventory_transaction_id}">
                            ...
                            <small class="text-danger" v-if="errors.inventory_transaction_id"
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group" :class="{'has-danger': errors.comments}">
                            ...
                            <small class="text-danger" v-if="errors.comments" v-text="errors.comments[0]"></small>
                        </div>
                    </div>
                </div>
            </div>
